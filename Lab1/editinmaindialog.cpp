...
//EditInMainDialog::EditInMainDialog(const Recipe recipe, const QModelIndexList select,QWidget *parent) :
...
//void EditInMainDialog::on_applyButton_clicked_data_edited()
//{
